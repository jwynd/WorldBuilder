...
setMountSm = (e) => {
  ...
  <div>
     ...
     <input type="number" name="Size" id="Size" onChange={e => this.setSize(e)}/>
     <label> Smoothness of Coast </label>
     <input type="number" name="ConastSmoothness" id="ConastSmoothness" onChange={e => this.setConast(e)}/>
     <label> Set inland Number </label>
     <input type="number" name="Inland" id="Inland" onChange={e => this.setIsd(e)}/>
     <label> Set Beach Height </label>
     <input type="number" name="BeachHeight" id="BeachHeight" onChange={e => this.setBeaHgh(e)}/>
     <label> Set Coast Uniformity</label>
     <input type="number" name="CoastUniformity" id="CoastUniformity" onChange={e => this.setCoastUni(e)}/>
     <label> Set Number of Rivers </label>
     <input type="number" name="NumRivers" id="NumRivers" onChange={e => this.setRiv(e)}/>
     <label> Set Number of Mountain Ranges </label>
     <input type="number" name="NumMountainRanges" id="NumMountainRanges" onChange={e => this.setMount(e)}/>
     <label> Set Mountain Width Range </label>
     <input type="number" name="WidthMountainRange" id="WidthMountainRange" onChange={e => this.setWidMount(e)}/>
     <label> Set Squiggliness </label>
     <input type="number" name="Squiggliness" id="Squiggliness" onChange={e => this.setSqyu(e)}/>
     <label> Set Mountain Smoothness </label>
     <input type="number" name="MountainSmoothness" id="MountainSmoothness" onChange={e => this.setMountSm(e)}/>
